...
#' @param pathway.geneset Pathway geneset, a R object of list which include
#' tags (pathway name) and values (gene list).
#'
...
#'
#' @return A data frame include t and p value of pathways and corresponding background,
#' dim=(4*num(pathways), nmcs).
#' @export
#'
#' @examples
...
#' @param weight Whether calculate the weighted activity score, weighted means that
#' the variance contribution rate of MCA reduction is used as the weight of each dimension.
#' @param normalize Normalize method, The choices are NULL, "z-score" and "bg-score", default "z-score".
#' "z-socre" means z-score normalize, "bg-score" means normalize by background activity score.
#'
...
#' @param method Binarization method, The choices are "GMM", "kmeans", default set to "GMM".
#' "GMM" is Gaussian Mixture Model, "kmeans" is K-means cluster.
#'
